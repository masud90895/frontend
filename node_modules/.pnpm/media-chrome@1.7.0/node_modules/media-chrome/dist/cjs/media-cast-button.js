...
const updateAriaLabel = (el) => {
  const isCast = el.getAttribute(import_constants.MediaUIAttributes.MEDIA_IS_CASTING) != null;
  const label = isCast ? import_labels.verbs.EXIT_CAST() : import_labels.verbs.ENTER_CAST();
