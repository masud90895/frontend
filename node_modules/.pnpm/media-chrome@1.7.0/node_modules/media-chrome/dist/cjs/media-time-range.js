...
shouldRangeAnimate_fn = function() {
  return this.isConnected && (0, import_element_utils.isElementVisible)(this) && !this.mediaPaused && !this.mediaLoading && !this.mediaEnded;
};
