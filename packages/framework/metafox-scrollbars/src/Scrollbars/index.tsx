...
> {
  ...
  constructor(props, ...rest) {
    ...
    this.handleEnterContainer = this.handleEnterContainer.bind(this);
    this.handleContainerHover = this.handleContainerHover.bind(this);
    this.handleContainerLeave = this.handleContainerLeave.bind(this);
  ...
  addListeners() {
    ...
    view.addEventListener('mouseenter', this.handleEnterContainer);

    if (!getScrollbarWidth()) return;

    if (container) {
      container.addEventListener('mousemove', this.handleContainerHover);
      container.addEventListener('mouseleave', this.handleContainerLeave);
    }
  ...
  removeListeners() {
    ...
    view.removeEventListener('mouseenter', this.handleEnterContainer);

    if (!getScrollbarWidth()) return;

    if (container) {
      container.removeEventListener('mousemove', this.handleContainerHover);
      container.removeEventListener('mouseleave', this.handleContainerLeave);
    }
  ...
  render() {
    ...
    const viewStyle = {
      ...
      marginBottom: scrollbarWidth && !hideX ? -scrollbarWidth : 0,
    ...
    return (
      ...
      >
        ...
        <HorizontalTrack
          ...
          style={{ opacity: 0, ...trackHorizontalStyle }}
          hide={hideX}
        >
          <HorizontalThumb
            ref={x => {
        ...
        <VerticalTrack
          style={{ opacity: 0, ...trackVerticalStyle }}
          ref={x => {
