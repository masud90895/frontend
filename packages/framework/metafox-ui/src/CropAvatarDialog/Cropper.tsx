  ...
  computeSizes = () => {
    ...
    if (mediaRef && this.containerRef) {
      ...
      this.mediaSize = {
        ...
        naturalWidth:
          this.imageRef?.naturalWidth || this.videoRef?.videoWidth || 0,
        naturalHeight:
          this.imageRef?.naturalHeight || this.videoRef?.videoHeight || 0
      };
        ...
        {image ? (
          <img
            ...
            style={{
              ...
              transform:
                transform ||
                `translate(${x}px, ${y}px) rotate(${rotation}deg) scale(${
                  zoom * scaleX
                }, ${zoom * scaleY})`
            }}
        ...
        {this.state.cropSize && (
          <div
            ...
            className={classNames(
              ...
              'round' === cropShape && 'reactEasyCrop_CropAreaRound',
