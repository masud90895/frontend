...
yargs(hideBin(process.argv))
    .middleware(argv => {
    process.env.MFOX_BUILD_PROFILE = argv.profile || 'metafox';
    process.env.MFOX_BUILD_TYPE = argv.type || 'web';
    ...
    .command('build', 'Build production release', {
    profile: {
        description: 'profile name',
        type: 'string'
    }
}, buildApp)
    .command('package:bundle [package]', 'Bundle a package', {
    publish: {
    ...
    .command('build:process', 'Process build single task', {
    profile: {
        description: 'profile name',
        type: 'string'
    },
    ...
    .command('reload', 'Reload project Settings', {
    profile: {
        describe: 'build name',
        type: 'string'
    },
