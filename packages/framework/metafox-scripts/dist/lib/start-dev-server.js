...
function formatUrlHref({ protocol, host, port, pathname }) {
...
function prepareUrls(protocol, host, port, pathname = '/') {
    const formatUrl = (host) => formatUrlHref({
        protocol,
        host,
        port: port.toString(),
        pathname
    });
    const prettyPrintUrl = (host) => formatUrlHref({
        protocol,
        host,
...
const stopServer = () => devServer.stopCallback(() => {
