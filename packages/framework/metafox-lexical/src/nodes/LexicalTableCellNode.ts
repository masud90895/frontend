...
import { TableCellNode as TableCellNodeDefault } from '@lexical/table';
...
/** @noInheritDoc */
export class TableCellNode extends TableCellNodeDefault {
  /** @internal */
  __colSpan: number;
  /** @internal */
  __rowSpan: number;
  ...
  exportDOM(editor: LexicalEditor): DOMExportOutput {
    ...
    if (element) {
      ...
      element_.style.border = '1px solid';
      ...
      // }px`;
      element_.style.width = `${this.getWidth() || '75'}px`;
      ...
      if (backgroundColor !== null) {
        ...
        element_.style.backgroundColor = '#828080';
      }
    }
